...
export const FLEET_VENTURES: VentureItem[] = [
  {
    ...
    features: [
      "IRS Section 41 scanner",
      "ASC 730 wage matrix",
      "Instant audit binder export",
      "Onboarding tour + AI copilot",
    ],
    cinematicPrompt:
      "Holographic glowing financial ledger in dark glass vault, neon emerald laser scanning corporate tax documents, 3d data streams, 8k cinematic lighting, octane render",
  },
  {
    ...
    features: [
      "Full OOXML track-changes",
      "Indemnification detector",
      "Redline diff viewer",
      "Client-side zero-retention",
    ],
    cinematicPrompt:
      "Futuristic floating legal contract with luminous purple and indigo track-change highlights, holographic security seals, dark minimalist room, 8k cinematic motion",
  },
  {
    id: "codevortex-sre",
    name: "CodeVortex SRE",
    ...
    features: [
      "Distributed trace classifier",
      "Synthetic error injection",
      "AST diff generator",
      "SRE incident copilot",
    ],
    cinematicPrompt:
      "Cyberpunk server room with glowing cyan fiber optic cables, floating terminal windows parsing log streams, glitch-free holographic HUD, volumetric fog, 8k",
  },
  {
    id: "synthmed-ai",
    name: "SynthMed AI",
    ...
    features: [
      "EHR-ready SOAP notes",
      "ICD-10 & CPT extraction",
      "Differential diagnosis",
      "HIPAA zero-cloud design",
    ],
    cinematicPrompt:
      "Futuristic medical diagnostic suite with floating emerald DNA helix, glowing biometric holographic HUD, high-tech stethoscope, frosted glass surfaces, 8k",
  },
  {
    id: "adgenesis-ai",
    name: "AdGenesis AI",
    ...
    features: [
      "50+ multi-platform matrix",
      "Multi-armed bandit simulator",
      "Dynamic CSV export",
      "Interactive creative copilot",
    ],
    cinematicPrompt:
      "Giant holographic 3D billboard matrix in a neon-lit Tokyo cyberpunk square, floating glass ad cards animating dynamically, vibrant magenta and rose reflections, 8k",
  },
  {
    id: "tenderbot-global",
    ...
    features: [
      "FAR/DFARS compliance audit",
      "Win-probability scoring",
      "Executive brief exporter",
      "Bidding assistant drawer",
    ],
    cinematicPrompt:
      "Futuristic government intelligence command center, holographic world map with glowing procurement corridors, dark obsidian glass consoles, emerald data pings, 8k",
  },
  {
    id: "qualicheck-ai",
    name: "QualiCheck AI",
    ...
    features: [
      "Pixel-level defect bounding",
      "Yield rate telemetry",
      "Defect frame isolation",
      "Metrology copilot drawer",
    ],
    cinematicPrompt:
      "Robotic industrial inspection arm scanning a glowing silicon microchip wafer, neon laser grid projecting defect heatmaps, microscopic lens reflections, 8k render",
  },
  {
    id: "talentpulse-ai",
    name: "TalentPulse AI",
    ...
    features: [
      ...
      "AST anti-cheat detection",
      "Automated rubric grading",
      "Candidate interview copilot",
    ],
    cinematicPrompt:
      "Floating holographic code matrix with emerald and teal syntax trees, interactive 3D algorithm puzzle assembling itself, dark glass interface, 8k",
  },
  {
    id: "datalightning-ai",
    ...
    features: [
      "DuckDB-WASM columnar engine",
      "Natural language to SQL",
      "Zero-cloud data privacy",
      "Executive brief export",
    ],
    cinematicPrompt:
      "Holographic glowing data lake with cyan columnar prisms shifting dynamically, lightning-fast particle query streams, dark reflective water floor, 8k",
  },
  {
    id: "hyperlocalize-ai",
    ...
    features: [
      "Millisecond-accurate SRT parser",
      "Cultural nuance adaptation",
      "Reading speed WPM calculator",
      "Studio copilot drawer",
    ],
    cinematicPrompt:
      "Cinematic audio-waveform timeline floating in 3D space, neon rose sound frequencies pulsing into multilingual subtitle ribbons, anamorphic lens flare, 8k",
  },
];
