...
const FAQ = [
  ...
  },
  {
    ...
    a: "Sprints start at $299 for a fixed-scope 5–7 day delivery. Studio retainer is $799 for ongoing development. Platform engagements are custom. All include 100% code ownership, deployment, and zero lock-in. No recurring license fees — unlike Cursor/Lovable subscriptions that charge for access.",
  },
  {
