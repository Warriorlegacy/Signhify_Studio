...
function SectionBadge({
  ...
  return (
    <span className="inline-flex items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.2em] text-[#4ade80] mb-4 bg-[#22c55e]/10 px-3.5 py-1.5 rounded-full border border-[#22c55e]/25 shadow-[0_0_20px_rgba(34,197,94,0.15)]">
      <Icon size={11} className="text-[#22c55e]" />
      {label}
    </span>
  );
}
      ...
      <div className="flex items-center gap-2">
        {TESTIMONIALS.map((_, i) => (
          <button
            ...
            className={`rounded-full transition-all duration-300 ${i === index ? "w-6 h-1.5 bg-[#22c55e]" : "w-1.5 h-1.5 bg-white/20 hover:bg-white/40"}`}
          />
        ))}
      </div>
...
function PresetGallery() {
  return (
    ...
    >
      <div className="absolute top-1/2 left-0 w-[min(100%,480px)] h-[min(100%,480px)] -translate-y-1/2 rounded-full blur-[140px] pointer-events-none bg-[#22c55e]/[0.06]" />
      <div className="relative w-full">
        <div className="max-w-3xl mx-auto px-5 md:px-6 mb-10 md:mb-14">
          <Reveal className="text-center">
            <div className="flex items-center justify-center gap-2 mb-4">
              <span className="tag inline-flex">
                <Layers size={10} className="text-[#4ade80]" /> PRESET GALLERY
              </span>
              <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-[0.14em] bg-[#22c55e]/10 border border-[#22c55e]/30 text-[#4ade80]">
        ...
        <div className="max-w-[1400px] mx-auto px-2 sm:px-4 md:px-6 lg:px-8">
          ...
          <div className="mt-20 flex flex-col items-center gap-4">
            <Reveal className="text-center mb-8">
              <span className="inline-flex items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.18em] text-[#4ade80] mb-3">
                <Quote size={10} className="text-[#22c55e]" /> From our community
              </span>
    ...
    <section id="features" className="relative z-10 py-24 md:py-32 scroll-mt-20 overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-5 md:px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4 md:gap-4 relative">
          <div className="hidden xl:block absolute top-1/2 left-[8%] right-[8%] h-[1px] bg-gradient-to-r from-transparent via-[#22c55e]/30 to-transparent -translate-y-1/2 z-0" />
          {PIPELINE.map((step, i) => {
              ...
              <Reveal key={step.n} from="up" delay={i * 90} className="relative z-10 h-full">
                <div className="relative bg-white/[0.02] rounded-3xl border border-white/[0.04] p-6 md:p-8 h-full group hover:bg-[#22c55e]/5 hover:border-[#22c55e]/30 transition-all duration-500 backdrop-blur-md shadow-[0_10px_40px_rgba(0,0,0,0.3)]">
                  ...
                  <div className="relative z-10 flex flex-col h-full items-center text-center">
                    ...
                    <span className="text-[10px] font-mono font-bold text-[#4ade80] uppercase tracking-widest mb-3">
                      {step.n}
                    </span>
                    <h3 className="text-white font-semibold text-[18px] mb-3 tracking-tight">
                      {step.title}
                    </h3>
        ...
        <Reveal className="flex items-center justify-center gap-3 mt-10">
          {[0, 1, 2, 3, 4].map((i) => (
            <div key={i} className="flex items-center gap-3">
              <div className="w-2 h-2 rounded-full bg-[#22c55e]/60 border border-[#22c55e]/30" />
              {i < 4 && <div className="w-8 h-px bg-[#22c55e]/20" />}
            </div>
          ))}
        </Reveal>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          <Reveal from="left">
            ...
            <div className="flex flex-wrap items-center gap-4">
              <Link
                to="/builder"
                className="group relative px-8 py-4 rounded-[15px] text-[14px] font-bold bg-[#22c55e] text-black hover:bg-[#4ade80] hover:shadow-[0_0_24px_rgba(34,197,94,0.55)] transition-all duration-300 flex items-center gap-3"
              >
                Try the Builder
          ...
          <Reveal from="right">
            <div className="relative rounded-3xl border border-white/[0.08] bg-[#080c16] shadow-[0_20px_60px_rgba(34,197,94,0.12)] p-2 group hover:border-[#22c55e]/40 transition-colors duration-500 backdrop-blur-md">
              ...
              <div className="rounded-2xl overflow-hidden relative">
                <div className="absolute inset-0 bg-gradient-to-tr from-[#22c55e]/10 via-transparent to-[#22c55e]/10 z-10 pointer-events-none mix-blend-overlay" />
                <div className="relative aspect-[4/3] bg-gradient-to-b from-[#080c16] to-[#030712] overflow-hidden">
                  <video
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
          {PRO_TOOLS.map((tool, i) => {
            ...
            return (
              ...
              >
                <div className="relative overflow-hidden rounded-3xl border border-white/[0.04] bg-white/[0.02] p-8 md:p-10 h-full group hover:border-[#22c55e]/30 hover:bg-white/[0.03] transition-all duration-500 backdrop-blur-md shadow-[0_10px_40px_rgba(0,0,0,0.3)]">
                  <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-[#22c55e]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none" />
                  <div className="relative z-10 flex flex-col h-full justify-between">
                    <div className="w-14 h-14 rounded-2xl bg-white/[0.03] border border-white/[0.05] shadow-inner flex items-center justify-center mb-16 text-white group-hover:text-[#22c55e] transition-all duration-500 group-hover:scale-110 group-hover:shadow-[0_0_24px_rgba(34,197,94,0.2)]">
                      <Icon size={24} />
                    </div>
                    <div>
                      <h3 className="text-white font-semibold text-[20px] md:text-[24px] tracking-tight mb-3">
                        {tool.title}
                      </h3>
    ...
    <section className="relative z-10 py-24 md:py-40 overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-5 md:px-6 relative z-10">
        <div className="rounded-[40px] border border-white/[0.06] bg-white/[0.02] p-8 md:p-16 lg:p-24 overflow-hidden relative backdrop-blur-md shadow-[0_20px_80px_rgba(0,0,0,0.5)]">
          <div className="absolute top-0 left-0 w-[420px] h-[420px] bg-[#22c55e]/12 rounded-full blur-[120px] pointer-events-none -translate-x-1/3 -translate-y-1/3" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center relative z-10">
            <Reveal from="left">
              ...
              <div className="flex flex-wrap gap-4 items-center">
                ...
                <Link
                  to="/pricing"
                  className="px-8 py-4 rounded-full text-[14px] font-bold text-white bg-white/5 border border-white/10 hover:bg-white/10 hover:border-[#22c55e]/40 transition-all duration-300"
                >
                  View Pricing
                </Link>
              </div>
              ...
              {STATS.map((stat, i) => {
                ...
                return (
                  <Reveal key={stat.label} from="scale" delay={i * 100}>
                    <div className="bg-white/[0.02] border border-white/[0.04] rounded-3xl p-6 md:p-8 flex flex-col justify-center items-start group hover:bg-white/[0.04] hover:border-[#22c55e]/30 transition-all duration-300 shadow-inner">
                      <Icon
                        size={24}
                        className="text-white/60 mb-4 group-hover:text-[#22c55e] transition-colors duration-300 group-hover:scale-110"
                      />
                      <div className="font-display text-3xl md:text-4xl font-bold text-white tracking-tight mb-2">
                        {stat.value}
                      </div>
