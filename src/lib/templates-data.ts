...
export const TEMPLATES: TemplateItem[] = [
  // ── 0. SIGNHIFY VENTURE LAB FLEET (10 PRODUCTION AI PRESETS) ────
  {
    id: "auditmind-ai",
    name: "AuditMind AI Ledger & R&D Tax Vault",
    category: "SaaS & AI",
    tag: "Fintech & Tax",
    gradient: "from-emerald-950 via-[#05140b] to-black",
    accent: "#10b981",
    secondaryAccent: "#34d399",
    badge: "God-Level Prompt",
    frames: 420,
    fps: 60,
    desc: "Autonomous IRS Section 41 qualification engine with ASC 730 wage allocation matrix and real-time audit risk binder generation.",
    longDesc: "Enterprise tax intelligence platform with zero-server client-side compute. Features interactive wage matrices, four-part test verification engine, and instant PDF audit binder export.",
    features: [
      "IRS Section 41 qualification scanner",
      "ASC 730 R&D wage allocation matrix",
      "Instant multi-year audit binder PDF export",
      "Client-side ledger rules engine (0 server latency)",
      "Interactive onboarding tour + Groq AI copilot",
    ],
    techStack: ["React 19", "Tailwind CSS v4", "Groq Llama-3.3-70B", "jsPDF", "Canvas"],
    godLevelPrompt: "A dark glass financial vault with emerald laser beams scanning holographic tax ledgers, glowing numbers flying into 3D binders, 8k cinematic scroll motion",
    mockStats: [
      { label: "Avg Claim Identified", value: "$42,500" },
      { label: "Audit Risk", value: "< 1.2%" },
      { label: "Compute Rail", value: "Pure Client" },
    ],
    particleMode: "quantum",
  },
  {
    id: "contractsentinel-ai",
    name: "ContractSentinel AI OOXML Redliner",
    category: "SaaS & AI",
    tag: "Legal & Risk",
    gradient: "from-indigo-950 via-[#090a1f] to-black",
    accent: "#6366f1",
    secondaryAccent: "#818cf8",
    badge: "God-Level Prompt",
    frames: 450,
    fps: 60,
    desc: "Enterprise DOCX redlining engine with non-destructive OOXML track-changes injection and zero-cloud retention.",
    longDesc: "Autonomous contract risk review workspace. Parses native Word documents, highlights indemnification/liability exposure, and exports valid track-changes DOCX files entirely in-browser.",
    features: [
      "Full OOXML track-changes non-destructive parser",
      "Indemnification & liability clause detector",
      "Interactive redline diff side-by-side viewer",
      "Client-side zero-retention privacy architecture",
      "Groq AI legal assistant copilot drawer",
    ],
    techStack: ["React 19", "JSZip", "OOXML Parser", "Groq Llama-3.3", "Tailwind CSS"],
    godLevelPrompt: "A floating transparent legal parchment in dark space with glowing purple and indigo track-change highlights redlining text smoothly on scroll, 8k",
    mockStats: [
      { label: "Review Latency", value: "< 2.4s" },
      { label: "File Format", value: "Native DOCX" },
      { label: "Data Retention", value: "0 ms / Memory" },
    ],
    particleMode: "luxury",
  },
  {
    id: "codevortex-sre",
    name: "CodeVortex SRE Kubernetes Triage",
    category: "SaaS & AI",
    tag: "DevOps & SRE",
    gradient: "from-cyan-950 via-[#04161a] to-black",
    accent: "#06b6d4",
    secondaryAccent: "#22d3ee",
    badge: "God-Level Prompt",
    frames: 480,
    fps: 60,
    desc: "Zero-latency incident triage engine converting messy Kubernetes stack traces into verified syntax-valid code diffs.",
    longDesc: "Next-gen SRE platform. Classifies distributed trace errors, generates AST code patches, and injects synthetic test errors for chaotic resilience validation.",
    features: [
      "Distributed trace & Kubernetes log classifier",
      "In-browser AST syntax-valid diff generator",
      "Synthetic incident chaos injector",
      "Automated root-cause triage incident timeline",
      "Interactive SRE copilot terminal drawer",
    ],
    techStack: ["React 19", "AST Diff Engine", "Tailwind CSS v4", "Lucide", "Groq AI"],
    godLevelPrompt: "A futuristic cyberpunk server room with glowing cyan fiber optics, floating terminal code diff windows reacting to scroll with glitch-free parallax, 8k",
    mockStats: [
      { label: "MTTR Reduction", value: "78%" },
      { label: "Patch Validity", value: "99.8%" },
      { label: "Triage Speed", value: "< 1.8s" },
    ],
    particleMode: "cyberpunk",
  },
  {
    id: "synthmed-ai",
    name: "SynthMed AI Clinical SOAP Scribe",
    category: "SaaS & AI",
    tag: "Healthcare AI",
    gradient: "from-emerald-950 via-[#02180e] to-black",
    accent: "#10b981",
    secondaryAccent: "#059669",
    badge: "God-Level Prompt",
    frames: 500,
    fps: 60,
    desc: "Clinical dictation scribe transforming raw patient dialogue into structured SOAP clinical notes with verified ICD-10 and CPT codes.",
    longDesc: "HIPAA zero-cloud clinical AI scribe. Transcribes consultations, maps diagnoses to ICD-10 ontologies, and outputs EHR-ready billing summaries with zero patient data storage.",
    features: [
      "EHR-ready SOAP clinical documentation generator",
      "Automated ICD-10 & CPT billing code extraction",
      "Real-time differential diagnosis confidence matrix",
      "HIPAA zero-cloud in-memory client privacy",
      "Clinical copilot side-drawer with medical terminology",
    ],
    techStack: ["React 19", "Web Speech API", "Medical Ontology Engine", "Tailwind CSS"],
    godLevelPrompt: "A modern clinical hologram room with glowing emerald biometric waves, floating stethoscope and SOAP medical chart assembling as user scrolls, 8k",
    mockStats: [
      { label: "Coding Accuracy", value: "99.4%" },
      { label: "Time Saved", value: "3.2 hrs/day" },
      { label: "HIPAA Cloud Storage", value: "0 Bytes" },
    ],
    particleMode: "mesh",
  },
  {
    id: "adgenesis-ai",
    name: "AdGenesis AI Multi-Armed Bandit Studio",
    category: "3D Scroll",
    tag: "MarTech & Growth",
    gradient: "from-rose-950 via-[#180309] to-black",
    accent: "#f43f5e",
    secondaryAccent: "#fb7185",
    badge: "God-Level Prompt",
    frames: 520,
    fps: 60,
    desc: "Instantly generates 50+ multi-platform ad variations with dynamic Epsilon-Greedy multi-armed bandit ROAS optimization.",
    longDesc: "Performance marketing engine. Generates variations across Meta, Google, TikTok, and LinkedIn, simulating budget allocations with real-time Monte Carlo reinforcement learning.",
    features: [
      "50+ multi-channel ad copy matrix generator",
      "Multi-armed bandit budget simulator (Epsilon-Greedy)",
      "1-click dynamic CSV campaign export",
      "Interactive creative angle copilot drawer",
      "Real-time simulated ROAS & CTR lift calculator",
    ],
    techStack: ["React 19", "Bandit Algorithm Engine", "Recharts", "Tailwind CSS v4"],
    godLevelPrompt: "A neon Tokyo skyscraper square with 50 floating glass billboard cards rotating in 3D parallax on scroll, vibrant rose and magenta lighting, 8k",
    mockStats: [
      { label: "ROAS Uplift", value: "+3.4x" },
      { label: "Matrix Variants", value: "50+ Multi-Chan" },
      { label: "Optimization Time", value: "Instant" },
    ],
    particleMode: "galaxy",
  },
  {
    id: "tenderbot-global",
    name: "TenderBot Global RFP Compliance Command",
    category: "Dashboards",
    tag: "GovCon & Bids",
    gradient: "from-emerald-950 via-[#05160d] to-black",
    accent: "#10b981",
    secondaryAccent: "#34d399",
    badge: "God-Level Prompt",
    frames: 460,
    fps: 60,
    desc: "Government contracting intelligence platform extracting RFP requirements, scoring win probabilities, and drafting FAR/DFARS proposals.",
    longDesc: "GovCon enterprise bidding suite. Automates compliance matrices, evaluates RFP evaluation criteria, and drafts executive proposals in minutes rather than weeks.",
    features: [
      "FAR & DFARS clause compliance scanner",
      "Algorithmic win-probability scoring engine",
      "Executive brief & proposal draft exporter",
      "Interactive bidding assistant drawer",
      "Requirements traceability matrix builder",
    ],
    techStack: ["React 19", "Tailwind CSS", "Groq AI", "Recharts", "Lucide"],
    godLevelPrompt: "An obsidian military-grade command center with a 3D holographic globe and golden-emerald procurement radar pings turning on scroll, 8k",
    mockStats: [
      { label: "Proposal Drafting", value: "45 Mins" },
      { label: "Compliance Score", value: "100% FAR" },
      { label: "Avg Contract Size", value: "$4.2M" },
    ],
    particleMode: "energy",
  },
  {
    id: "qualicheck-ai",
    name: "QualiCheck AI Edge Metrology Vision",
    category: "3D Scroll",
    tag: "Computer Vision",
    gradient: "from-rose-950 via-[#150308] to-black",
    accent: "#f43f5e",
    secondaryAccent: "#fda4af",
    badge: "God-Level Prompt",
    frames: 480,
    fps: 60,
    desc: "In-browser computer vision metrology detecting micro-scratches, solder voids, and component misalignments at 60 FPS on HTML5 Canvas.",
    longDesc: "Industrial manufacturing QA suite. Executes edge computer vision algorithms directly over raw pixel buffers with 16ms/frame latency and yield telemetry.",
    features: [
      "Pixel-level edge defect bounding and segmentation",
      "Real-time manufacturing yield rate telemetry",
      "Defect frame isolation and crop inspection",
      "Interactive metrology copilot side-drawer",
      "Pure HTML5 Canvas zero-cloud vision compute",
    ],
    techStack: ["React 19", "HTML5 Canvas Metrology", "Web Workers", "Tailwind CSS v4"],
    godLevelPrompt: "A high-speed robotic camera inspecting a glowing silicon microchip wafer with neon red laser bounding boxes tracking defect pixels on scroll, 8k",
    mockStats: [
      { label: "Inference Speed", value: "16ms / frame" },
      { label: "Defect Accuracy", value: "99.8%" },
      { label: "FPS", value: "60 FPS Locked" },
    ],
    particleMode: "cyberpunk",
  },
  {
    id: "talentpulse-ai",
    name: "TalentPulse AI Pyodide WASM Sandbox",
    category: "SaaS & AI",
    tag: "HRTech & Assessment",
    gradient: "from-emerald-950 via-[#02150a] to-black",
    accent: "#10b981",
    secondaryAccent: "#4ade80",
    badge: "God-Level Prompt",
    frames: 440,
    fps: 60,
    desc: "Executes candidate Python code directly in browser via Pyodide WebAssembly with AST anti-cheat telemetry and automated grading.",
    longDesc: "Next-gen technical interview platform. Zero backend execution servers — runs full Python interpreter inside the browser sandbox with AST keystroke cadence analysis.",
    features: [
      "In-browser Pyodide WebAssembly Python runtime",
      "AST keystroke & paste anti-cheat detection",
      "Automated rubric grading & time-complexity analysis",
      "Live candidate interview copilot drawer",
      "Custom assessment test-case generator",
    ],
    techStack: ["React 19", "Pyodide WASM", "Monaco Editor", "Tailwind CSS v4"],
    godLevelPrompt: "An emerald WebAssembly code matrix with 3D floating syntax trees and interactive terminal puzzles clicking into place as the user scrolls, 8k",
    mockStats: [
      { label: "Sandbox Latency", value: "0ms Local" },
      { label: "Anti-Cheat Fidelity", value: "99.7%" },
      { label: "Execution Engine", value: "Pyodide WASM" },
    ],
    particleMode: "matrix",
  },
  {
    id: "datalightning-ai",
    name: "DataLightning AI DuckDB Columnar Studio",
    category: "Dashboards",
    tag: "BigData & SQL",
    gradient: "from-cyan-950 via-[#03151c] to-black",
    accent: "#06b6d4",
    secondaryAccent: "#67e8f9",
    badge: "God-Level Prompt",
    frames: 500,
    fps: 60,
    desc: "Ultra-fast SQL analytics processing million-row Parquet and CSV files in browser memory with natural language Text-to-SQL.",
    longDesc: "Client-side big data workspace powered by DuckDB-WASM. Query massive datasets with columnar vectorized execution and generate charts with zero cloud server compute costs.",
    features: [
      "DuckDB-WASM in-browser columnar query engine",
      "Natural language prompt to optimized SQL generator",
      "Zero-cloud data privacy (data never leaves RAM)",
      "Instant executive brief and interactive chart export",
      "Parquet and CSV streaming ingestion",
    ],
    techStack: ["React 19", "DuckDB-WASM", "Recharts", "Tailwind CSS v4"],
    godLevelPrompt: "A dark reflective room with cyan columnar database prisms rising from the floor with lightning particle streams connecting SQL queries on scroll, 8k",
    mockStats: [
      { label: "Row Scan Speed", value: "10M rows/s" },
      { label: "Cloud Server Cost", value: "$0.00" },
      { label: "Engine", value: "DuckDB-WASM" },
    ],
    particleMode: "quantum",
  },
  {
    id: "hyperlocalize-ai",
    name: "HyperLocalize AI Subtitle & Audio Studio",
    category: "3D Scroll",
    tag: "Media & Localization",
    gradient: "from-rose-950 via-[#140209] to-black",
    accent: "#f43f5e",
    secondaryAccent: "#fb7185",
    badge: "God-Level Prompt",
    frames: 460,
    fps: 60,
    desc: "Localizes video subtitles across 12+ international markets with automated millisecond audio-timing preservation and cultural idiom adaptation.",
    longDesc: "High-precision video localization suite. Parses SRT/VTT timelines, preserves audio sync to 0.00ms drift, and adapts regional slang with AI cultural intelligence.",
    features: [
      "Millisecond-accurate SRT & VTT timestamp parser",
      "Cultural nuance and idiomatic localization engine",
      "Reading speed WPM & character-per-second calculator",
      "Studio localization copilot drawer",
      "Multi-market subtitle ribbon previewer",
    ],
    techStack: ["React 19", "SRT Engine", "Web Audio API", "Tailwind CSS v4"],
    godLevelPrompt: "A floating 3D audio waveform pulsing in neon rose, unfurling multilingual subtitle ribbons across world flags on scroll, 8k anamorphic",
    mockStats: [
      { label: "Timing Drift", value: "0.00 ms" },
      { label: "Supported Locales", value: "12+ Markets" },
