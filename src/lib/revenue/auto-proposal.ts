...
function pickOffer(input: ProposalInput) {
  ...
  if (
    normalizedBudget.includes("$15,000") ||
    normalizedBudget.includes("$50,000") ||
    input.tier === "hot"
  ) {
    return {
      offerType: "Platform",
  ...
  if (
    normalizedBudget.includes("$799") ||
    normalizedBudget.includes("studio") ||
    input.tier === "warm"
  ) {
    return {
      offerType: "Studio",
  ...
  if (offerType === "Sprint") {
    return [
      ...
      },
      {
        ...
        description: "Technical plan, stack selection, and UX direction.",
      },
      {
        day: 3,
        title: "Build core",
        description: "Implement the primary workflow and AI integration.",
      },
      {
        day: 4,
        title: "QA & polish",
        description: "Fix edge cases, optimize, and prepare for handoff.",
      },
      {
        day: 5,
        title: "Delivery & walkthrough",
        description: "Deploy, record walkthrough, and hand over assets.",
      },
    ];
  }
  if (offerType === "Studio") {
    return [
      {
        ...
        description: "Deep-dive into product requirements and user flows.",
      },
      {
        day: 2,
        title: "Architecture & UX",
        description: "System design, component architecture, and visual direction.",
      },
      {
        day: 3,
        title: "AI integration",
        description: "Wire AI capabilities, prompts, and automation.",
      },
      { day: 4, title: "Full build", description: "End-to-end implementation with live preview." },
      {
        day: 5,
        title: "QA & hardening",
        description: "Performance tuning, security review, and bug fixes.",
      },
      {
        day: 6,
        title: "Launch prep",
        description: "Deploy pipeline, monitoring, and handoff docs.",
      },
  ...
  return [
    {
      ...
      description: "Business goals, user research, and delivery roadmap.",
    },
    {
      week: 2,
      title: "Architecture",
      description: "Scalable platform design, data model, and integrations.",
    },
    {
      week: 3,
      title: "Core platform",
      description: "Authentication, billing, admin, and core workflows.",
    },
    { week: 4, title: "AI layer", description: "AI capabilities, prompt systems, and automation." },
    {
      week: 5,
      title: "Integrations",
      description: "Third-party integrations, webhooks, and APIs.",
    },
...
function buildSummary(
  input: ProposalInput,
  offer: { offerType: string; priceCents: number; timelineDays: number; title: string },
) {
...
export const generateProposal = createServerFn({ method: "POST" })
  .inputValidator((input: unknown) => {
    ...
    const tier =
      obj?.tier === "hot" || obj?.tier === "warm" || obj?.tier === "cold" ? obj.tier : "cold";
    if (
      !leadId ||
      !name ||
      !email ||
